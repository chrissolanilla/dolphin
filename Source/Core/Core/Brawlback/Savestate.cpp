...
void BrawlbackSavestate::initBackupLocs()
{
  ...
  static std::vector<ssBackupLoc> fullBackupRegions = {
      ...
      */
      ...
      //{0x80494880, 0x80494880 + 0x1108D4}, // bss  0x80494880 - 0x805A5154  (according to
      //brawlcrate)

      //{0x80001800, 0x80003000, nullptr}, // default gecko code region

      // mem1
      {0x805b8a00, 0x805b8a00 + 0x17c, nullptr,
       "gfTaskScheduler"},  // gfTaskScheduler (fixes special move crashes)
      ...
      //{0x80673460, 0x80673460+0x28D380, nullptr, "OverlayCommon first half"}, // OverlayCommon
      //first half
      //{/*0x80673460+0x28D380*/0x809007E0, 0x80b8db60, nullptr, "OverlayCommon second half"}, //
      //OverlayCommon second half

      //{/*0x80673460+0x28D380*/0x809007E0, 0x809007E0+0x1469C0, nullptr, "OverlayCommon 3/4"}, //
      //OverlayCommon 3/4
      {/*0x80673460+0x28D380*/ 0x809007E0 + 0x1469C0, 0x80b8db60, nullptr,
       "OverlayCommon 4/4"},  // OverlayCommon 4/4
      ...
      //{0x9151fa00, 0x91a72e00, nullptr, "Fighter1Resource"}, // Fighter1Resource  (crashes without
      //this, but it's so big... need to cut this down)
      {0x9151fa00, 0x9151fa00 + 0x2A9A00, nullptr,
       "first half of Fighter1Resource"},  // first half of Fighter1Resource
      //{0x9151fa00 + 0x2A9A00, 0x91a72e00, nullptr, "second half of Fighter1Resource"}, // second
      //half of Fighter1Resource

      //{0x91b04c80, 0x92058080, nullptr, "Fighter2Resource"}, // Fighter2Resource
      {0x91b04c80, 0x91b04c80 + 0x2A9A00, nullptr,
       "Fighter2Resource first half"},  // Fighter2Resource first half
      //{0x91b04c80+0x2A9A00, 0x92058080, nullptr, "Fighter2Resource second half"}, //
      //Fighter2Resource second half
